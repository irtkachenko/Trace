...
Веб-додаток на базі Next.js 16 та React 19. Сучасний месенджер з функціоналом авторизації та роботи з даними.

## Опис проєкту

Telegraf - сучасний месенджер, який включає:
...
```bash
docker exec -it telegraf-app pnpm install
```
